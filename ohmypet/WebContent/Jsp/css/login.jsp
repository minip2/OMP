...
<body>
	<div class="container">
		...
		<h1>로그인</h1>
		<p>${error}</p>
		<form action="http://localhost:8000/ohmypet/com.omp.css.controller/login">
		<table>
			...
			<tr>
				<td><form action="http://localhost:8000/ohmypet/Html/join/join.html"><button>회원가입</button></form></td>
