    ...
    <div class="thumbnail">
      ...
      <c:forEach var="video" items="${videoList}">
        <video width="300" controls>
  	       ...
  	       <source src="http://localhost:8000/ohmypet/data/dictionary/upload${video.videoPath}/${video.videoSystemName}" >
  	    </video>  
        <div class="caption">
          <h3><c:out value="${video.no}" />.<c:out value="${video.title}" /></h3>
          <p>설명</p>
          <p>
            <a href="${pageContext.request.contextPath}/com/omp/dictionary/util/download?path=${video.videoPath}&sname=${video.videoSystemName}&dname=${video.videoOrgName}" class="btn btn-primary" role="button">다운로드</a>
